...
try:
    ...
    with open("data/anagram.txt") as fileobj:
...
# Step 1 - dividing the large file into small subfiles
# Finding the lens of the words and storing it in the words_len
words_len = list(map(len, words))

# Framing a dictionary containing the words as keys and len as their values
...
# Step2 - to find anagram words from the modified list
